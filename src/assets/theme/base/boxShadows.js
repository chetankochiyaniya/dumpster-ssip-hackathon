...
/**
 * The base box-shadow styles for the Dumpster dashboard PRO React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Dumpster dashboard PRO React using thie file.
 */
